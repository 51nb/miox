...
function cssBlock(isVue) {
    var devArray = [cssLoader()];
    var proArray = [styleLoader(), cssLoader()];
...
function lessBlock(isVue) {
    var devArray = [cssLoader(), lessLoader()];
    var proArray = [styleLoader(), cssLoader(), lessLoader()];
...
function sassBlock(isVue) {
    var devArray = [cssLoader(), sassLoader()];
    var proArray = [styleLoader(), cssLoader(), sassLoader()];
